  ...
  signIn() async {
    try {
      ...
      Map<String,dynamic> data = <String,dynamic>{
        ...
        "Password": _password.text,
        "Phone Number": _phone.text,
        "Emergency Contact 1": _phone1.text,
        "Emergency Contact 2": _phone2.text,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextFormField(
                        autofocus: false,
                        keyboardType: TextInputType.text,
                        decoration: InputDecoration(prefixIcon: Icon(Icons.phone),hintText: 'Enter your phone no as +91xxxxxxxxxx',
                          labelText: 'Phone No',
                          contentPadding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(32.0)),
                        ),
